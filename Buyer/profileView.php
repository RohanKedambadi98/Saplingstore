            ...
            <div class="inner">
                ...
                <header>
                    <center>
                        ...
                        ?>
<br>
                    <span><img height=200px width=200px src="<?php echo 'images/profileImages/'.$_SESSION['picName'].'?'.mt_rand(); ?>" class="image-circle" class="img-responsive" height="200%"></span>
                    <br>
