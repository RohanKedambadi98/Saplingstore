    ...
    <body class="subpage">
        ...
        <section id="post" class="wrapper bg-img" data-bg="banner2.jpg">
            <div class="inner">
                <div class="box">
                <header>
                    <span class="image left"><img  src="<?php echo 'images/profileImages/'.$_SESSION['picName'].'?'.mt_rand(); ?>" class="img-circle" height=200px width=200px class="img-responsive" ></span>
                    <br>
                ...
                <form method="post" action="Profile/updateProfile.php">
                    <div class="row uniform">
                        ...
                        <div class="6u 12u$(xsmall)">
                            <input type="text" name="Addr" id="Addr" value="<?php echo $_SESSION['Addr'];?>" placeholder="Email" required/>
                        </div>
                        <!-- <div class="6u 12u$(xsmall)">
                        ...
                        <div class="6u 12u$(xsmall)">
                            <input type="text" name="post" id="post" value="<?php echo $_SESSION['Addr'];?>" placeholder="Adderss" required/>
                        </div>
                      <!-- <p>
                            <b>Education : </b>
                        </p>
