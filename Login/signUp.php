...
if($category == 1)
{
    ...
    $resultm = mysqli_query($conn, "SELECT * FROM farmer WHERE fmobile='$mobile'") or die($mysqli->error());
...
else
{
    ...
    $resultm = mysqli_query($conn, "SELECT * FROM buyer WHERE bmobile='$mobile'") or die($mysqli->error());
