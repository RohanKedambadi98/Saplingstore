...
<html lang="en">
	...
	?>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">Sapling Store &copy; </h3>
			<!-- <div class="logo">
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Sapling Store<span>Karnataka</span></p>
			</div>
			<div>
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:agroculture@gmail.com" style="color:white">saplingstore@support.com</a></p>
			</div>
		</div>,

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About Sapling Store</b></span>
				AgroCulture is e-commerce trading platform for tree saplings...
			</p>
    ...
    <h3>Login</h3>
							<form method="post" action="Login/login.php">
								<div class="row uniform 50%">
									...
									<input type="checkbox" id="showp" onClick="show()">
...
<section>
							...
							<form method="post" action="Login/signUp.php">
								...
								<div class="row uniform">
									<div class="3u 12u$(xsmall)">
										<input type="text" pattern="[0-9]{10}" name="mobile" id="mobile" value="" placeholder="Mobile Number" required/>
									</div>
