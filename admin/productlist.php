...
?>
    <tr>
        ...
        <td>
            <form action="productlist.php" onsubmit="return confirm('are you sure?')" method="POST">
                <button value="<?php echo $row['pid'] ;?> "  name="pid" style="color:green;" type="submit">delete</button>
            </form>
